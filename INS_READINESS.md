...
statAfrikR est une boite a outils statistique R conçue specifiquement
pour les Instituts Nationaux de Statistique (INS) d’Afrique
subsaharienne. Il couvre le cycle complet de production statistique
(GSBPM phases 4-7) avec des methodologies conformes aux standards
internationaux.
...
**Environnement :** Fonctionne hors ligne (terrains, bureaux sans
internet)
...
produit un rapport de validation couvrant 10 criteres institutionnels :
...
**Criteres evalues :** 1. Qualite donnees (completude, doublons) 2.
Poids de sondage (CV, outliers, valeurs negatives) 3. Valeurs manquantes
(par variable, seuil configurable) 4. Geographie (couverture, regions
avec n\<30) 5. Precision statistique (DEFF, methode IC recommandee) 6.
Confidentialite (cellules \< seuil, defaut=5) 7. Metadonnees (taux de
documentation) 8. Reproductibilite (version, date, pays) 9. Indicateurs
cles (FGT0 + CV si disponible) 10. Statut global : VALIDE / A VERIFIER /
ECHEC
