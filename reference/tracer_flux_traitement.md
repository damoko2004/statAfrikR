...
#> [2026-05-23 23:42:47] Import (3 lignes x 2 colonnes)
  e2 <- tracer_flux_traitement(e1$donnees, action="Nettoyage", journal=e1$journal)
#> [2026-05-23 23:42:47] Nettoyage (3 lignes x 2 colonnes)
  print(e2$journal)
#> # A tibble: 2 × 5
#>   horodatage          action    n_lignes n_colonnes details
#>   <chr>               <chr>        <int>      <int> <chr>  
#> 1 2026-05-23 23:42:47 Import           3          2 NA     
#> 2 2026-05-23 23:42:47 Nettoyage        3          2 NA     
# }
```
