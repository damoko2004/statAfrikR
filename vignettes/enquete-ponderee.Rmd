---
title: "Analyse d'une enquête pondérée complète"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Analyse d'une enquête pondérée complète}
...
Démographique et de Santé (EDS) ou d'une Enquête sur les Conditions de Vie
(EMOP/EMICOV), avec pondération complexe (strates + grappes).
...
```{r eval=FALSE, stats-descriptives}
stats <- stat_descr(
  plan,
...
```{r eval=FALSE, pyramide, fig.cap="Pyramide des âges des chefs de ménage"}
library(ggplot2)
pyramide_ages(
  donnees_eds,
  var_age   = "age_chef",
...
```{r eval=FALSE, barres, fig.cap="Dépense moyenne par région"}
...
```{r eval=FALSE, diffusion, eval=FALSE}
# Anonymisation
